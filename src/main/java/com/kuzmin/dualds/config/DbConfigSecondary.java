package com.kuzmin.dualds.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.kuzmin.dualds.hystory"})
@Slf4j
public class DbConfigSecondary {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
            ...
            @Qualifier("dataSourceHistory")
            DataSource dataSource) {
        log.info("Secondary EM initialized");
        return builder
                .dataSource(dataSource)
                .packages("com.kuzmin.dualds.hystory")
    ...
    public PlatformTransactionManager transactionManager(
            @Qualifier("entityManagerFactoryHistory") EntityManagerFactory
